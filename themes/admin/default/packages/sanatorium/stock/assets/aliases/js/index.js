...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'alias');

		$('.daterangepicker_end_input').attr('data-grid', 'alias');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('alias', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
